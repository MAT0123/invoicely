...
export default function DataManagement({invoices , settings , setInvoices , setSettings , deleteAllInvoice}: {invoices: Invoice[] , settings: CompanySettings , setInvoices: (invoices:Invoice[]) => void , setSettings: (settings:CompanySettings) => void , deleteAllInvoice: () => void}) {
  return (
