...
import { Invoice, StatusType, TabType } from '../home/page';
...
const AllInvoices: React.FC<AllInvoicesProps> = ({ invoices, setActiveTab , updateInvoiceStatus , getStatusColor , setNewInvoice , deleteInvoice }) => {
  return (
    <div className="space-y-6">
                ...
                {invoices.length === 0 ? (
                  <div className="bg-white p-12 rounded-lg shadow-lg border-2 border-gray-400 text-center">
                    ...
                    <p className="text-black mb-6">Create your first invoice to get started.</p>
                    <button
                          ...
                          {invoices.map((invoice) => (
                            <tr key={invoice.id} className="hover:bg-gray-50">
                              <td className="px-6 py-4">
                                <div className="text-sm font-bold text-black">{invoice.invoiceNumber}</div>
                              </td>
                              <td className="px-6 py-4">
                              ...
                              <td className="px-6 py-4">
                                <div className="text-sm text-black font-medium">{invoice.invoiceDate}</div>
                              </td>
                              <td className="px-6 py-4">
                                <div className="text-sm text-black font-medium">{invoice.dueDate}</div>
                              </td>
                              <td className="px-6 py-4">
                                <select
                              ...
                              <td className="px-6 py-4 text-right">
                                <div className="text-sm font-bold text-black">${invoice.total.toFixed(2)}</div>
                              </td>
                              <td className="px-6 py-4">
